...
console app simples (o template padrão) é criado:
...
| `console`      | Um aplicativo de linha de comando (template padrão).                                                       |
| `package`      | Um pacote contendo bibliotecas Dart compartilhadas.                                                           |
| `server-shelf` | Um servidor construído usando [shelf][].                                                                       |
| `web`          | Um web app construído usando bibliotecas core do Dart.                                                            |
...
### Forçar criação do projeto

Se o diretório especificado já existe, `dart create` falha.
