...
funcionam para desenvolvimento de aplicações web em navegadores modernos.

:::note
Dart 2.18 remove a ferramenta de linha de comando `dartdevc` do pacote Dart,
mas mantém o compilador dartdevc.
