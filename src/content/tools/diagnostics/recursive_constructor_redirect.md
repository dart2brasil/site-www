...
O analisador produz este diagnóstico quando a constructor redirects to
...
at least one of the constructors to not redirect to another construtor:
...
- Redirect to a generative construtor:
...
- Not redirect to another construtor:
