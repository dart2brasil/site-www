...
_Apenas classes e mixins podem ser usados como constraints de superclasse._

## Description

O analisador produz este diagnóstico quando um tipo após a palavra-chave `on`
...
Se o tipo era para ser uma classe mas foi digitado incorretamente, então substitua o
nome.
