...
_O type deferred '{0}' não pode ser usado em uma declaração, cast, ou teste de type._
...
Se você precisa referenciar o tipo importado, então remova a keyword
`deferred`:
...
apropriado, então use esse tipo no lugar do tipo da biblioteca
deferred.
